...
import it.gcantoni.swiftmask.camera.CameraConnectionFragment;
import it.gcantoni.swiftmask.camera.LegacyCameraConnectionFragment;
import it.gcantoni.swiftmask.utils.GesturesUtils;
...
public abstract class MainActivity extends AppCompatActivity
    ...
    private BottomSheetDialog bottomSheetPermission;
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        appBarLayout.addOnOffsetChangedListener(new AppBarLayout.OnOffsetChangedListener() {
            ...
            public void onOffsetChanged(final AppBarLayout appBarLayout, int verticalOffset) {
                ...
                if (scrollRange + verticalOffset == 0) {
                    toolbar.setBackgroundColor(ContextCompat.getColor(MainActivity.this, R.color.colorPrimarySurface));
                    Window window = getWindow();
                    window.addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS);
                    window.setStatusBarColor(getColor(R.color.colorPrimarySurface));
                } else {
        ...
        GesturesUtils.enableEdgeToEdgeNavigation(this, MainActivity.this);
        ...
        btnSwitchCam = findViewById(R.id.camera_switch);
    ...
    private void requestPermission() {
        @SuppressLint("InflateParams") final View bottomNav = getLayoutInflater().inflate(R.layout.bottom_sheet_start,null);
        bottomSheetPermission = new BottomSheetDialog(MainActivity.this, R.style.BottomSheetDialogTheme);
        bottomSheetPermission.setContentView(bottomNav);

        getWindow().setNavigationBarColor(getColor(android.R.color.transparent));
        bottomSheetPermission.setCancelable(true);
        bottomSheetPermission.show();

        bottomSheetPermission.setOnDismissListener(dialogInterface -> {
            grantPermission();
    ...
    public void grantPermission() {
        ...
        if(bottomSheetPermission.isShowing())
...
//        }
    ...
    protected abstract void setVoice(Boolean voice_on);
}
